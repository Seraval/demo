    ...
    <div class="container h-100">
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          ...
          <h2 class="text-uppercase text-center mb-5">Anxiety<br><p> Anxiety Scale</p></h2>
            ...
            <div class="card mb-2" style="border-radius: 15px;">
                <div class="card-body p-4 mb1 "> <!--NUMBER 1 (s)-->
                    ...
                    <p><strong>1  Do you worry about a lot of things? </strong></p>
            ...
            <div class="card mb-2" style="border-radius: 15px;">
                <div class="card-body p-4 mb1 "> <!--NUMBER 2 (a)-->
                    ...
                    <p><strong>2 Do you experience having rapid breathing or breathlessness? </strong></p>
            ...
            <div class="card mb-2" style="border-radius: 15px;">
                <div class="card-body p-4 mb1 "> <!--NUMBER 3 (d)-->
                    ...
                    <p><strong>3 Did you ever experienced involuntary shaking with your hands or legs? </strong></p>
            ...
            <div class="card mb-2" style="border-radius: 15px;">
                <div class="card-body p-4 mb1 "> <!--NUMBER 4 (a)-->
                    ...
                    <p><strong>4  How often do you feel that you are close to panic? </strong></p>
            ...
            <div class="card mb-2" style="border-radius: 15px;">
                <div class="card-body p-4 mb1 "> <!--NUMBER 5-->
                    ...
                    <p><strong>5 Have you ever experienced worrying or having fear for no specific reason? </strong></p>
            ...
            <div class="card mb-2" style="border-radius: 15px;">
                <div class="card-body p-4 mb1 "> <!--NUMBER 6-->
                    ...
                    <p><strong>6  have you ever made a fool out of yourself because of panic?</strong></p>
            ...
            <div class="card mb-2" style="border-radius: 15px;">
                <div class="card-body p-4 mb1 "> <!--NUMBER 7-->
                    ...
                    <p><strong>7 Does worrying make you feel fatigued or worn out? </strong></p>
            ...
            <div class="card mb-2" style="border-radius: 15px;">
                <div class="card-body p-4 mb1 "> <!--NUMBER 8-->
                    ...
                    <p><strong>8 (s) Do your muscle get tense (tight) whenever you feel anxious or worried?</strong></p>
            ...
            <div class="card mb-2" style="border-radius: 15px;">
                <div class="card-body p-4 mb1 "> <!--NUMBER 9-->
                    ...
                    <p><strong>9 Do you get irritable and/or easily annoyed when anxious?</strong></p>
            ...
            <div class="card mb-2" style="border-radius: 15px;">
                <div class="card-body p-4 mb1 "> <!--NUMBER 10-->
                    ...
                    <p><strong>10 Do you find it difficult controlling your worries? </strong></p>
