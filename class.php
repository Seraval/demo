...
class mentalHealth {
    ...
    public function assesment(){   //DASS21
        ...
        if(isset($_POST['submit'])){
                ...
                $stress = $test1 + $test6 + $test8 + $test11 + $test12 + $test14 + $test18;
                $anxiety = $test2 + $test4 + $test7 + $test9 + $test15 + $test19 + $test20;
                $depression = $test3 + $test5 + $test10 + $test13 + $test16 + $test17 + $test21;
    ...
    public function percentage(){   //GETTING THE PERCENTAGE
    ...
    public function anxiety(){ //anxiety
        ...
        if(isset($_POST['submit'])){
                ...
                if ($and <= 10 ) {
                    ...
                    header("location:anxiety.php?action=assesment4");
        ...
        public function stress(){  //stress
            ...
            if(isset($_POST['submit'])){
                    ...
                    if ($and <= 10 ) {
                        ...
                        header("location:stress.php?action=assesment4");
        ...
        public function depression(){    //depression
            ...
            if(isset($_POST['submit'])){
                    ...
                    if ($and <= 10 ) {
                        ...
                        header("location:depression.php?action=assesment4");
    
                    } else {
    
                        header("location:depression.php?action=assesment5");
